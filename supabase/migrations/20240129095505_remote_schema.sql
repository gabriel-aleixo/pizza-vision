...
ALTER TABLE ONLY "public"."photos"
    ADD CONSTRAINT "photos_pkey" PRIMARY KEY ("user_id");
...
CREATE POLICY "Enable all operations for users based on user_id" ON "public"."photos" TO authenticated USING ((auth.uid() = user_id));
